...
>This repository contains the official implementation for the paper "CAS: A Probability-based Approach for Universal Condition Alignment Score" <br> by Chunsan Hong, Byunghee Cha, Tae-Hyun Oh.
